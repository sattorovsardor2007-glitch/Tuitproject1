...
const AddTeacherDrawer = ({ isOpen, onClose, onSave }) => {
  ...
  const handleSave = () => {
    if (!formData.phone || !formData.fullName || !formData.address) {
      alert("Iltimos, barcha majburiy maydonlarni to'ldiring!");
      return;
    }
    // Call onSave with the teacher data
    onSave({
      ...formData,
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-start justify-between p-6 border-b border-gray-100">
            <div className="flex flex-col gap-1">
              <h2 className="text-xl font-bold text-gray-800">O'qituvchi qo'shish</h2>
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[14px] font-semibold text-gray-700">
                  O'qituvchi FIO <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  name="fullName"
